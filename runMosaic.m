...
HomographyMatches = {};
for i=1:length(cylindricalImage)
    i2 = mod(i, length(cylindricalImage)) + 1;
    [HomographyMatrix_temp, HomographyMatches_temp] = Ransac(siftFeatures{i}, siftDescriptors{i},siftFeatures{i2}, siftDescriptors{i2});
    fprintf('Ransac for %d & %d image is over\n',i,i2)
